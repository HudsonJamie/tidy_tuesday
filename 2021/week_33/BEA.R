...
plot_1 + plot_2 +
  ...
  plot_annotation(
    ...
    subtitle = "On the 7th August 2021, the Intergovernmental Panel on Climate Change (IPCC) finalised its Sixth Assessment Report. \nDespite a damning assessment on the climate crisis affecting the world, U.S. investment in infrastructure relating to Conservation \nand Development (i.e. dams, levees, sea walls, and related assets) is not increasing with inflation.",
