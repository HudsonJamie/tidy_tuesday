...
legend <- ggplot() +
  geom_circle(aes(x0 = 0, y0 = 1, r = .8), fill = "green") +
  geom_arc_bar(aes(x0 = 0, y0 = 1, r0 = 1.5, r = 2.5, start = 0.8,
                   end =  -0.8), fill = "green", radius = unit(2.5, 'mm')) +
...
map <- ggplot(broadbands) +
  geom_circle(aes(x0 = 0, y0 = 1, r = 0.9,  fill = circle)) +
  lims(x = c(-5.5, 5.5),
       y = c(0, 8.5)) +
  geom_arc_bar(aes(x0 = 0, y0 = 1, r0 = 1.5, r = 2.5, start = 0.8,
                   end =  -0.8, fill = bar_one), radius = 0.039) +
  geom_arc_bar(aes(x0 = 0, y0 = 1, r0 = 3.5, r = 4.5, start = 0.8,
                   end =  -0.8, fill = bar_two), radius = 0.039) +
  geom_arc_bar(aes(x0 = 0, y0 = 1, r0 = 5.5, r = 6.5, start = 0.8,
                   end =  -0.8, fill = bar_three), radius = 0.039) +
  scale_fill_identity() +
  coord_fixed() +
